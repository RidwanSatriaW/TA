...
<form method="POST" action="{{ route('data.edit_validation') }}">
    @csrf
<div class="row">
            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit Visitor Data</h4>
                        ...
                        <div class="form-group{{ $errors->has('visitor_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="visitor_name" type="text" class="form-control" name="visitor_name" value="{{ $visitor->visitor_name }}" >
                        ...
                        <div class="form-group{{ $errors->has('visitor_email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="visitor_email" type="text" class="form-control" name="visitor_email" value="{{ $visitor->visitor_email }}" disabled >
                        ...
                        <div class="form-group{{ $errors->has('visitor_mobile_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="visitor_mobile_no" type="text" class="form-control" name="visitor_mobile_no" value="{{ $visitor->visitor_mobile_no }}" >
                        ...
                        <div class="form-group{{ $errors->has('visitor_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="visitor_address" type="text" class="form-control" name="visitor_address" value="{{ $visitor->visitor_address }}" >
                        ...
                        <input type="hidden" name="hidden_id" value="{{ $visitor->id }}" />
