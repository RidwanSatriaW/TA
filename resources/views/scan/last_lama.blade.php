            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="hide" id="result-container">
                    <h2>Result</h2>
                    <span id="result-name"></span><p id="emoticon"></p>
                    <p id="result-perc"></p>
                    <canvas width="200" height="200" id="Input"></canvas>
                </div>
                
                <input type="text" hidden name="visitor_id" id="visitor_id" value="{{ $visitor->id }}">
                {{-- <input type="text" hidden name="visitor_email" id="visitor_email"  value="{{ $visitor['visitor_email'] }}">
                <input type="text" hidden name="visitor_mobile_no" id="visitor_mobile_no"  value="{{ $visitor['visitor_mobile_no'] }}">
                <input type="text" hidden name="visitor_address" id="visitor_address"  value="{{ $visitor['visitor_address'] }}"> --}}
